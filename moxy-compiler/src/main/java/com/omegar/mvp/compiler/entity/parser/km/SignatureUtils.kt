 ...
 *
 * @return the name of this [Element] in its "form".
 */
 ...
 * @see [JvmDescriptorTypeVisitor]
 */
fun TypeMirror.descriptor(types: Types): String =
 ...
 * @see [JvmDescriptorTypeVisitor]
 */
fun WildcardType.descriptor(types: Types): String =
 ...
 * @see [JvmDescriptorTypeVisitor]
 */
fun TypeVariable.descriptor(types: Types): String =
        types.erasure(this).descriptor(types)
 ...
 * @see [JvmDescriptorTypeVisitor]
 */
fun ArrayType.descriptor(types: Types): String =
 ...
 * @see [JvmDescriptorTypeVisitor]
 */
fun ExecutableType.descriptor(types: Types): String {
 ...
 */
fun ExecutableElement.jvmMethodSignature(types: Types): String {
 ...
 * For reference, see the [JVM specification, section 4.3](https://docs.oracle.com/javase/specs/jvms/se7/html/jvms-4.html#jvms-4.3).
 */
fun VariableElement.jvmFieldSignature(types: Types): String {
    return "$simpleName:${asType().descriptor(types)}"
}
