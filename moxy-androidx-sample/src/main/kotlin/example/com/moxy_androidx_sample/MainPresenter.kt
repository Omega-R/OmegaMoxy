...
class MainPresenter : BasePresenter<Contract.MainView<Double>>() {
	...
	private var test1: String? by savedNullState(null)
	private var test2: String? by savedNullState("null")
	private var test3: String by savedState("null")
	private var test5: Int by savedState(56)
	private var test6: Bitmap by savedState(Bitmap.createBitmap(10,10,Bitmap.Config.ARGB_8888))
